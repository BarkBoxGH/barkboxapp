...
import HomeBkg from "../assets/HomeBkg.png"
import Home2Bkg from "../assets/Home2Bkg.png"

const HomePage = () => {
  return (
    <div>
      <section id="homeBg" className="h-[100vh] overflow-hidden bg-cover bg-center m-0 p-0 flex justify-content items-center px-[5%]" style={{ backgroundImage: `url(${HomeBkg})` }}>
        <Navbar />
      ...
      <section className="h-[100vh] bg-[white] flex justify-center items-center">
        <div className="w-[60%] h-full" style={{ backgroundImage: `url(${Home2Bkg})` }}>
