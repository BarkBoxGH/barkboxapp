...
const HomePage = () => {
  return (
    <div>
      <section id="homeBg" className="overflow-x-hidden w-full lg:h-[100vh] h-[80vh] overflow-hidden bg-[#1E3A8A] lg:lg:m-0 lg:p-0 lg:flex lg:justify-content lg:items-center">
        <Navbar />
        <div className="px-[5%] flex flex-col lg:w-[50%] lg:pl-[15%]">
         ...
         <Link to="/viewservices"><button className="p-[0.6em] border-white border-2 rounded-md text-[1em] font-bold w-[70%] lg:w-[40%] mt-[1em] text-[white]">View our Services</button></Link>
         <Link to="/admin/register"><button className="p-[0.6em] border-white border-2 rounded-md text-[1em] font-bold w-[70%] lg:w-[40%] mt-[1em] text-[white]">Register a Service</button></Link>
         </div>
      ...
      <section className="h-[100vh] grid grid-rows-2 lg:mb-[10%] lg:h-[100vh] w-full bg-[white] lg:flex lg:justify-center lg:items-center overflow-x-hidden">
        <div className="lg:w-[60%] w-[100%] bg-center lg:h-full bg-no-repeat bg-contain" style={{ backgroundImage: `url(${Home2Bkg})` }}>

        </div>
        <div className="lg:w-[40%] px-[3%] h-full lg:px-[4em] w-[80%] lg:pt-[10%]">
          ...
          <Link to="/viewservs">
            <button className="p-[1em] lg:p-[0.6em] bg-[#1E3A8A] text-[white] rounded-md text-[1.3em] lg:text-[1em] font-bold ">Book an Appointment</button>
          </Link>
        </div>
      </section>
