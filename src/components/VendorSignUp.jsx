...
import vendorSideDog from "../assets/vendorSideDog.svg"
const VendorSignUp = () => {
  ...
  return (
    ...
    <section className="h-[100vh] bg-[#A8DEF8] py-[3%] px-[15%]">
      <div className=" h-[100%] bg-white w-[100%] rounded-3xl flex">
        ...
        <img src={vendorSideDog} className=""/>
        </div>
        <div className="w-[50%] bg-[white] rounded-3xl z-10 flex flex-col pt-[3%] px-[5%] ml-auto mr-auto">
          <div className="h-[10%] mb-[0.5em] flex">
            ...
            <h1 className="text-[1.8em] font-bold">Create Account - Vendor</h1>
          </div>
          ...
          <form onSubmit="" className="mt-[10%] h-[100%]">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-center">Already have an account? <Link to="/vendorlogin" className="underline text-[black]">Log In</Link></p>
            </div>
          </form>
        </div>
      </div>
